...
public final class Protocol {
  ...
  public static enum Command implements ProtocolCommand {
    ...
    GEORADIUSBYMEMBER, GEORADIUSBYMEMBER_RO, MODULE, BITFIELD, HSTRLEN, TOUCH, SWAPDB, HELLO, 
    SQLSHOWTABLE, SQLGETRELIABLEREDUNDANCY, SQLCREATETABLE, SQLINSERT, SQLSELECT, SQLUPDATE, SQLDELETE;
